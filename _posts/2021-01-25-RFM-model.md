...
The goal of this project was to rank the customers of an insurance company to improve customer care. The RFM model, which evaluates customers based on the recency, frequency, and monetary value of their purchases, was identified as a simple yet highly effective and easily interpretable technique.
...
Often times it is enough for a company's marketing department to rank its customers by their value for the company instead of calculating the exact dollar amoumt of they will potentially spent with the conpany. This was the case in my client, Netrisk.hu, the largest Hungarian insurance brokerage company.
