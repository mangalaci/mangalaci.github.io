...
- [00. Project Overview](#overview-main)
    - [Adapting the base RFM model to suit our business invironment](#overview-context)
...
### Adapting the base RFM model to suit our business invironment <a name="overview-context"></a>
