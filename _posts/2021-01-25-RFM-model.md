...
Since insurance industry typically operates in a subscription company-customer relationship, dimensions like recency and frequency are not the best modes of categorizing and ranking customers value to the serving company. In a subscription business all time related features become awkward or meaningless. Recency has minor importance since   Modifying or customizing the standard RFM model to align with the specific needs, characteristics, or operational context of your business.

This implies that the base RFM framework was tailored to better fit the unique aspects of your company's goals, customers, or industry requirements.
