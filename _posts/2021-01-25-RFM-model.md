...
##### Population to be analyzed: I extracted the contract table from the company's relational database. (Customers identities are deduplicated in the system already.) 
