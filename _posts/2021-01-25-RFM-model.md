...
<br>
#### RM_Scores: Creating Quintiles

RM_Score = recency_cat + m1_tercile, where m1_tercile is the a sum_alltime_CASCO_MTPL_HOME_annual_fee_per_user column assinged into quintiles. For instance:

K1 = recency_cat[only MTPL] + m1_tercile[customer is in lowest spending quintile]
